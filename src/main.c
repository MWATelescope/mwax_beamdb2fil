...
int main(int argc, char *argv[])
{
  ...
  client->open_function = dada_dbfil_open;
  client->io_function = dada_dbfil_io;
  client->io_block_function = dada_dbfil_io_block;
  client->close_function = dada_dbfil_close;
